...
public class DataSet {
    ...
    public static final List<String> lowerCaseAlphabetList = List.of("a", "b", "c", "a", "d", "e", "f", "e", "g", "h", "i");
    ...
    public static List<Integer> generateArrayList(int maxNumber) {
    ...
    public static List<Integer> generateIntegerLinkedList(int maxNumber) {
